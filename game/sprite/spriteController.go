...
func CreateSpriteController(img *ebiten.Image, xPos float64, yPos float64) *SpriteController {
	sprite := CreateInCenter(img, utils.GenerateUid(), xPos, yPos, 1, 1)
	return &SpriteController{img, sprite, xPos, yPos, utils.GenerateUid(), true}
}
